...
$sql = "CREATE TABLE IF NOT EXISTS roles_actualizaciones (
    id_rol_actualizacion INT AUTO_INCREMENT PRIMARY KEY,
    id_rol INT NOT NULL,
...
if ($conn->query($sql) === TRUE) {
    echo "Table roles_actualizaciones created successfully\n";
} else {
